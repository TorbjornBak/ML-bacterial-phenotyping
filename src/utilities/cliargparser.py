...
class ArgParser():
    ...
    def train_model_arguments(self):
        ...
        parser.add_argument("--train_split_method", default = "GroupKFold", choice = ["GroupKFold","GroupShuffleSplit"],help = "Sklearn method to use for train test splitting")
    ...
    def baseline_arguments(self):
        ...
        parser = self.default_arguments(parser)
        parser.add_argument("--submodule", default = "train", choices=["train", "pca", "feature_importance", "validation"], help = "Mode to run the script in, choose between train, pca, feature_importance, and validation.")
        ...
        parser.add_argument("--train_split_method", default = "GroupKFold", choices=["GroupShuffleSplit", "GroupKFold",  "ShuffleSplit", "StratifiedShuffleSplit", "StratifiedGroupKFold"], help = "Sklearn method to use for train test splitting.")
        ...
        parser.add_argument("-sm","--save_model", default = False, action="store_true", help = "Flag to indicate whether to save the best model during training")
        parser.add_argument("-mloc","--model_directory", default = None, help = "Path to model directory where model is saved during training, and used for validation ")
